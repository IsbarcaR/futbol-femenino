<nav>
    <ul class="flex space-x-4">
        ...
        <li><a href="/jugadoras" class="text-white hover:underline">Listado de jugadoras</a></li>
        <li><a href="/partidos" class="text-white hover:underline">Listado de partidos</a></li>
